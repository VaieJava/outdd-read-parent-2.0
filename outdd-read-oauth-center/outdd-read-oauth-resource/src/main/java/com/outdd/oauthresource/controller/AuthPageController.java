...
import com.outdd.oauthcommon.config.FromLoginConstant;
...
public class AuthPageController {
    ...
    public ResponseBase requireAuthentication(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        //如果访问的是接口资源
        return new ResponseBase(401, "访问的服务需要身份认证，请引导用户到登录页",12);
    }
